...
1.  **Empiricism:** Knowledge comes from experience. Decisions are based on what is observed, not what is predicted.
2.  **Lean Thinking:** Eliminating waste and focusing strictly on the essentials.
...
A Scrum Team is a small (usually $\le$ 10 people), **self-managing**, and **cross-functional** unit. There is no hierarchy; everyone is focused on a single objective.
